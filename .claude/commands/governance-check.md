...
4. If anything fails, propose remediation:
   ...
   - **Missing `.claude/` template** → next nightly run of `governance-auto-propagate.yml` will open a sync PR
   - **Content marker missing** → do NOT edit the marker out; this indicates a content drift that needs investigation
